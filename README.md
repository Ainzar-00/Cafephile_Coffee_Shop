...
<!-- Table: always 4 per row -->
<table>
  <tr>
    <td style="text-align:center; padding:8px;">
      <img src="https://github.com/user-attachments/assets/85d850db-7eb3-47f2-a73c-e3c39ae0f3fa" alt="Splash" style="width:220px; height:auto; border-radius:8px;" /><br>
      <small>SplashScreen</small>
    </td>
    <td style="text-align:center; padding:8px;">
      <img src="https://github.com/user-attachments/assets/2a047d7c-dfe6-443b-b2db-4add80b085cb" alt="Auth 1" style="width:220px; height:auto; border-radius:8px;" /><br>
      <small>Authentification — Écran 1</small>
    </td>
    <td style="text-align:center; padding:8px;">
      <img src="https://github.com/user-attachments/assets/51f24c5b-039a-4375-9097-ddf2824ebbd7" alt="Auth 2" style="width:220px; height:auto; border-radius:8px;" /><br>
      <small>Authentification — Écran 2</small>
    </td>
    <td style="text-align:center; padding:8px;">
      <img src="https://github.com/user-attachments/assets/92e080ad-776f-45cb-9916-f03cf682ccff" alt="Home" style="width:220px; height:auto; border-radius:8px;" /><br>
