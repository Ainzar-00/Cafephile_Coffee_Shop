...
<table>
  <tr>
    <td style="text-align:center; padding:8px;">
      <img src="https://github.com/user-attachments/assets/85d850db-7eb3-47f2-a73c-e3c39ae0f3fa" alt="SplashScreen" style="width:220px; height:auto; border-radius:8px;" /><br>
      <small>SplashScreen</small>
    </td>
    <td style="text-align:center; padding:8px;">
      <img src="https://github.com/user-attachments/assets/2a047d7c-dfe6-443b-b2db-4add80b085cb" alt="Authentification 1" style="width:220px; height:auto; border-radius:8px;" /><br>
      <small>Authentification — Écran 1</small>
    </td>
    <td style="text-align:center; padding:8px;">
      <img src="https://github.com/user-attachments/assets/51f24c5b-039a-4375-9097-ddf2824ebbd7" alt="Authentification 2" style="width:220px; height:auto; border-radius:8px;" /><br>
      <small>Authentification — Écran 2</small>
    </td>
    <td style="text-align:center; padding:8px;">
      <img src="https://github.com/user-attachments/assets/92e080ad-776f-45cb-9916-f03cf682ccff" alt="Home Screen" style="width:220px; height:auto; border-radius:8px;" /><br>
  ...
  <tr>
    <td style="text-align:center; padding:8px;">
      <img src="https://github.com/user-attachments/assets/dacfe928-1419-4c90-ab32-a7946cf5d55c" alt="Cart Screen" style="width:220px; height:auto; border-radius:8px;" /><br>
      <small>Cart Screen</small>
    </td>
    <td style="text-align:center; padding:8px;">
      <img src="https://github.com/user-attachments/assets/0d112060-a8ee-4e0e-963b-9d362afb4578" alt="Favorites Screen" style="width:220px; height:auto; border-radius:8px;" /><br>
      <small>Favorites Screen</small>
    </td>
    <td style="text-align:center; padding:8px;">
      <img src="https://github.com/user-attachments/assets/439459b6-0e47-4c53-a5d8-bd5952b7179e" alt="Profile Screen" style="width:220px; height:auto; border-radius:8px;" /><br>
      <small>Profile Screen</small>
    </td>
    <td style="text-align:center; padding:8px;">
      <img src="https://github.com/user-attachments/assets/0ebbbcb1-edb1-4f8c-bc74-eec80c0f0419" alt="Products Screen" style="width:220px; height:auto; border-radius:8px;" /><br>
      <small>Products Screen</small>
    </td>
  </tr>

  <tr>
    <td colspan="4" style="text-align:center; padding:8px;">
      <img src="https://github.com/user-attachments/assets/0e4e93b5-d9a7-47fd-ac8d-2e8195cd1a28" alt="Explore Screen" style="width:220px; height:auto; border-radius:8px;" /><br>
      <small>Explore Screen</small>
    </td>
  </tr>
</table>
